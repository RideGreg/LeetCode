...
# 1273 biweekly contest 14 11/30/2019
...
class Solution(object):
    def deleteTreeNodes(self, nodes, parent, value): # USE THIS
        """
        :type nodes: int
...
class Solution2(object):
    ...
    def deleteTreeNodes_ming(self, nodes, parent, value):
        import collections

        # depend on the assumption parent[i] < i. For 0->3->2->1, children node's value not fully passed up
        ...
        # mark off all nodes in subtree if subtree root has accumulated value 0
...
print(Solution().deleteTreeNodes(7, [-1,0,0,1,2,2,2], [1,-2,4,0,-2,-1,-1])) # 2
'''
      1
     / \
    -2  4
...
print(Solution().deleteTreeNodes(500,
